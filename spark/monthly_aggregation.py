...
spark = (
    ...
    .appName("ClimateMonthlyAggregation")
    .master("local[2]")
...
output_path = f"s3a://{MINIO_BUCKET}/processed/monthly/{YEAR}/"
...
monthly = (
    ...
    .agg(
        ...
        sum(
            when(col("HIGH_VOLATILITY") == 1, 1).otherwise(0)
...
print("SUCCESS: Monthly aggregation completed.")
